...
(() => {
  ...
  const MSG = {
    ...
    "filter.ownerId":     { zh: "归属者 ID（可选）", en: "Owner ID (optional)", ru: "ID владельца (опц.)" },
    "filter.sessionId":   { zh: "会话 ID（次级过滤，可选）", en: "Session ID (secondary filter)", ru: "ID сессии (вторичный фильтр)" },
    ...
    "graph.ownerLabel":   { zh: "归属者过滤", en: "Owner Filter", ru: "Фильтр владельца" },
    "graph.ownerPh":      { zh: "推荐：限定 owner_id", en: "Recommended: limit to owner_id", ru: "Рекомендуется: ограничить owner_id" },
    "graph.sessionLabel": { zh: "会话过滤", en: "Session Filter", ru: "Фильтр сессии" },
    "graph.sessionPh":    { zh: "可选：进一步限定 session_id", en: "Optional: further limit to session_id", ru: "Опц.: дополнительно ограничить session_id" },
    ...
    "recall.ownerLabel":  { zh: "归属者 ID（推荐）", en: "Owner ID (recommended)", ru: "ID владельца (рекомендуется)" },
    "recall.ownerPh":     { zh: "输入 owner_id，按长期归属者过滤记忆", en: "Enter owner_id to filter by long-term owner", ru: "Введите owner_id для фильтрации по владельцу памяти" },
    "recall.sessionLabel":{ zh: "会话 ID（次级过滤，可选）", en: "Session ID (secondary filter)", ru: "ID сессии (вторичный фильтр)" },
    "recall.sessionPh":   { zh: "需要更细粒度时再输入 session_id", en: "Use session_id only when you need finer filtering", ru: "Используйте session_id только для более тонкой фильтрации" },
    ...
    "detail.ownerId":     { zh: "归属者 ID", en: "Owner ID", ru: "ID владельца" },
